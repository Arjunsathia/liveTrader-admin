...
export function WithdrawalDetailPage() {
  ...
  const [localAudit, setLocalAudit] = useState([
    { action: 'Withdrawal requested', by: 'ClientPortal', ts: record.created },
    { action: 'Compliance checked', by: 'ComplianceEngine', ts: record.created, note: `Status: ${record.compliance}` },
    { action: 'AML checked', by: 'AML_Engine', ts: record.created, note: `Status: ${record.aml}` }
  ]);
