      ...
      <div className="flex h-full w-full flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-3">
          ...
          <Section step={2} icon={Settings} title="Account Setup">
            ...
            <PDivider label="Wallet Setup" />

            <PToggle
              label="Create Wallet"
              checked={draft.autoWallet}
              onChange={setField('autoWallet')}
              description="Create wallet folders and accounts automatically."
            />
          </Section>
          ...
          <Section step={3} icon={Monitor} title="MT5 Setup" collapsible>
            <PToggle
              ...
              description="Set up a placeholder MT5 account."
            />

            {draft.createMt5 && (
              <>
                <PDivider label="MT5 Settings" />
                <PGrid>
                  <PSelect
                    label="Server"
          ...
          <Section step={4} icon={FileText} title="Notes" collapsible>
            <PTextarea
              label="Notes"
              value={draft.note}
