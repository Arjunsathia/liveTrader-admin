...
const MOCK_TRANSACTIONS = [
  {
    ...
    referenceId: 'STRIPE-CHG-93820',
    notes: 'Instant deposit completed via Credit Card verification.',
    statusHistory: [
      { status: 'PENDING', date: 'Jun 5, 2026 10:12 AM' },
      { status: 'COMPLETED', date: 'Jun 5, 2026 10:14 AM' }
    ]
  },
  {
    id: 'TXN-839402',
    ...
    method: 'Bank Wire',
    source: 'USD Wallet',
    destination: 'Chase Bank (•••• 9876)',
    status: 'PENDING',
    date: '2026-06-04T15:30:00Z',
    referenceId: 'WIRE-WD-004812',
    notes: 'Bank transfer processing. Standard clearing takes 1-3 business days.',
    statusHistory: [
      { status: 'PENDING', date: 'Jun 4, 2026 03:30 PM' }
    ]
  },
  {
    id: 'TXN-739281',
    ...
    netAmount: 2495.00,
    method: 'USDT (TRC20)',
    source: 'External Address (TYuR...89s)',
    destination: 'USDT Wallet',
    status: 'COMPLETED',
    date: '2026-06-03T08:45:00Z',
    referenceId: 'TX-TRON-8492019',
    notes: 'Crypto blockchain confirmation success.',
    statusHistory: [
      { status: 'PENDING', date: 'Jun 3, 2026 08:40 AM' },
      { status: 'COMPLETED', date: 'Jun 3, 2026 08:45 AM' }
    ]
  },
  {
    id: 'TXN-639102',
    ...
    fee: 0.00,
    netAmount: -499.00,
    method: 'Prop Challenge Fee',
    source: 'USD Wallet',
    destination: 'Live-Trader Challenge Desk',
    status: 'COMPLETED',
    date: '2026-06-02T12:00:00Z',
    referenceId: 'PROP-100K-EVAL',
    notes: 'Evaluation Challenge Fee for 100K Premium Tier account.',
    statusHistory: [
      { status: 'COMPLETED', date: 'Jun 2, 2026 12:00 PM' }
    ]
  },
  {
    id: 'TXN-529103',
    ...
    referenceId: 'STRIPE-CHG-91023',
    notes: 'Transaction declined by issuer bank (3D Secure validation failure).',
    statusHistory: [
      { status: 'PENDING', date: 'Jun 1, 2026 02:18 PM' },
      { status: 'FAILED', date: 'Jun 1, 2026 02:20 PM' }
    ]
  },
  {
    id: 'TXN-419203',
    ...
    source: 'USD Wallet',
    destination: 'MT5 Trading Account #482910',
    status: 'COMPLETED',
    date: '2026-05-30T17:10:00Z',
    referenceId: 'MT5-TX-482910',
    notes: 'Instant internal transfer to MetaTrader terminal wallet.',
    statusHistory: [
      { status: 'COMPLETED', date: 'May 30, 2026 05:10 PM' }
    ]
  },
  {
    id: 'TXN-309210',
    ...
    netAmount: 2990.00,
    method: 'BTC Wallet',
    source: 'External Address (1A1z...G7d)',
    destination: 'BTC Wallet',
    status: 'COMPLETED',
    date: '2026-05-28T11:00:00Z',
    referenceId: 'TX-BTC-7201938',
    notes: 'Bitcoin Network Deposit (6+ network confirmations).',
    statusHistory: [
      { status: 'PENDING', date: 'May 28, 2026 10:30 AM' },
      { status: 'COMPLETED', date: 'May 28, 2026 11:00 AM' }
    ]
  },
  {
    id: 'TXN-291039',
    ...
    method: 'USDT (TRC20)',
    source: 'USDT Wallet',
    destination: 'External Address (TWsD...92k)',
    status: 'CANCELED',
    date: '2026-05-26T09:15:00Z',
    referenceId: 'TX-USDT-920193',
    notes: 'Withdrawal request canceled by user.',
    statusHistory: [
      { status: 'PENDING', date: 'May 26, 2026 09:00 AM' },
      { status: 'CANCELED', date: 'May 26, 2026 09:15 AM' }
    ]
  },
  {
    id: 'TXN-182903',
    ...
    netAmount: 150.00,
    method: 'System Wallet',
    source: 'Live-Trader Rewards Desk',
    destination: 'USD Wallet',
    status: 'COMPLETED',
    date: '2026-05-25T16:00:00Z',
    referenceId: 'REW-JUNE-BONUS',
    notes: 'Reward credit for participating in the June warm-up challenge.',
    statusHistory: [
      { status: 'COMPLETED', date: 'May 25, 2026 04:00 PM' }
    ]
  },
  {
    id: 'TXN-102948',
    ...
    method: 'System Wallet',
    source: 'USD Wallet',
    destination: 'Live-Trader Fee Collection',
    status: 'COMPLETED',
    date: '2026-05-24T08:00:00Z',
    referenceId: 'FEE-ACC-INACTIVE',
    notes: 'Account maintenance fee for inactive secondary wallets.',
    statusHistory: [
      { status: 'COMPLETED', date: 'May 24, 2026 08:00 AM' }
    ]
  }
];
...
export function ClientTransactionsPage() {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute('download', `LiveTrader_Transactions_${new Date().toISOString().split('T')[0]}.csv`);
