...
export function PortfolioChart() {
  ...
  if (!mounted) {
    return (
      <Card className="h-full p-0 flex flex-col overflow-hidden" padding={false}>
        <div className="px-5 py-4 border-b border-border/15 bg-surface-elevated/45 h-[64px]" />
        <div className="flex-1 bg-surface/5 flex items-center justify-center min-h-[300px]">
          <div className="text-[12px] text-text-muted font-mono">Loading performance data...</div>
        </div>
        <div className="grid grid-cols-4 border-t border-border/15 bg-surface-elevated/20 h-[48px]" />
      </Card>
    );
  }
