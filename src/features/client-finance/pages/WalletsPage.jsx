...
/** Hero balance card */
function HeroCard({ data, onDeposit, onWithdraw }) {
...
export function WalletsPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-up">
      ...
      <HeroCard
        data={WALLET_DATA}
        onDeposit={() => navigate('/client/finance/deposit')}
        onWithdraw={() => navigate('/client/finance/withdraw')}
      />

      {/* ── Stat cards row ── */}
      <StatCards data={WALLET_DATA} />
