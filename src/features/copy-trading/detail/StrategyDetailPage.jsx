  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-5">
        ...
        <KpiCard label="Max Drawdown" value={row.drawdown} color="var(--negative)" Icon={TrendingDown} sub="Peak-to-trough" />
        <KpiCard label="Copied Volume" value={row.copiedVol} color="var(--brand)" Icon={Copy} sub="Total allocated" />
      </div>
      ...
      {tab === 'overview' && (
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-5">
          <Card>
            <SH title="Strategy Summary" Icon={BookOpen} />
          ...
          <div className="space-y-4">
            <Card>
              <SH title="Risk Profile" Icon={ShieldAlert} />
              {[
                ['Risk Level', row.risk, RC[row.risk]],
                ['Max DD', row.drawdown, 'var(--negative)'],
                ['Win Rate', row.winRate, 'var(--cyan)'],
                ['ROI', row.roi, row.roiN > 0 ? 'var(--positive)' : 'var(--negative)'],
              ].map(([k, v, c]) => (
      ...
      {tab === 'performance' && (
        <div className="space-y-5">
          <Card>
            <SH title="Monthly ROI (%)" Icon={TrendingUp} />
      ...
      {tab === 'fee_rules' && (
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
          <Card>
            ...
            {[
              ['Performance Fee', row.fee, 'var(--warning)'],
          ...
          <Card>
            ...
            {[
              ...
              ['Auto-Pause DD', row.drawdown, 'var(--negative)'],
      ...
      {tab === 'activity' && (
        <Card>
          <SH title="Strategy Activity Log" Icon={Activity} />
