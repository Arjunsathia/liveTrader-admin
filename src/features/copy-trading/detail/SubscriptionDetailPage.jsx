      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_300px] gap-5">
        <div className="space-y-5">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            <KpiCard label="Plan" value={row.plan} color="var(--cyan)" Icon={Bookmark} sub="Subscription plan" />
            <KpiCard label="Allocation" value={row.alloc} color="var(--brand)" Icon={Wallet} sub="Copied capital" />
            <KpiCard label="Perf Fee" value={row.fee} color="var(--warning)" Icon={Percent} sub="Fee rate" />
          </div>
          <Card>
            <SH title="Subscription Settings" Icon={Settings} />
          ...
          <Card>
            <SH title="Subscription History" Icon={Activity} />
        ...
        <div className="space-y-4 xl:sticky xl:top-[120px]">
          <Card>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Add note about this subscription…"
          ...
          <div className="grid grid-cols-1 gap-2">
            <IBtn label="Change Plan" Icon={Edit2} variant="default" onClick={() => act('Plan change', row.id)} />
            <IBtn label="View Follower" Icon={User} variant="cyan" onClick={() => act('Follower viewed', row.id)} />
