...
const PAGE = {
  ...
  description: 'Audit subscriber portfolios copying live strategies, active capital allocations, and individual pnl impacts.',
};
    ...
    <PageShell>
      <div className="space-y-5 animate-fade-up">
        ...
        <section className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-3">
          <KpiCard label="Total Followers" value={followersData.length} color="var(--cyan)" Icon={Users} sub="All followers" />
          <KpiCard
            label="Active"
        ...
        <section className="rounded-[12px] border border-border/20 bg-surface-elevated shadow-card-subtle overflow-hidden">
          ...
          <MainTable
            ...
            emptyTitle="No followers found matching filters."
