...
const PAGE = {
  ...
  description: 'Manage strategy providers, kyc verification statuses, and review pending approval queues.',
};
    ...
    <PageShell>
      <div className="space-y-5 animate-fade-up">
        ...
        <section className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-3">
          <KpiCard label="Total Providers" value={providersData.length} color="var(--cyan)" Icon={Users} sub="All providers" />
          <KpiCard
            label="Active"
          ...
          <KpiCard
            ...
            urgent
          />
          <KpiCard label="Total AUM" value={totalAUM} color="var(--brand)" Icon={Wallet} sub="Copied capital" />
        </section>
        ...
        <section className="rounded-[12px] border border-border/20 bg-surface-elevated shadow-card-subtle overflow-hidden">
          ...
          <MainTable
            ...
            emptyTitle="No providers found matching filters."
