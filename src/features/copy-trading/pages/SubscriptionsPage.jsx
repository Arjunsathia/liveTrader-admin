...
const PAGE = {
  ...
  description: 'Track all active copy trading billing subscriptions, performance fee rates, and renewal calendars.',
};
      ...
      <div className="space-y-5 animate-fade-up">
        ...
        <section className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-3">
          ...
          <KpiCard
            ...
            urgent
          />
          <KpiCard label="Renewals Due" value={renewalsSoon} color="var(--warning)" Icon={CalendarDays} sub="Within 30 days" />
          <KpiCard label="Total Subs" value={subsData.length} color="var(--cyan)" Icon={CreditCard} sub="All subscriptions" />
        </section>
        ...
        <section className="rounded-[12px] border border-border/20 bg-surface-elevated shadow-card-subtle overflow-hidden">
          ...
          <MainTable
            ...
            emptyTitle="No subscriptions found matching filters."
