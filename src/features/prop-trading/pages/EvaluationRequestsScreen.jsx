...
import { evaluationRows } from '../data/workspaces/evaluation.workspace';
...
// Base column definitions — action column built inside component with ws.onAction bound
const BASE_COLS = [
...
export function EvaluationRequestsScreen() {
