...
export function ReportsOverviewPage() {
  ...
  const act = (action, label = '') => {
    const msgs = {
      'Generate Report': 'Generating real-time reports query…',
      'Schedule Export': 'Automated export schedule activated.',
      'Download All Ready': 'Bulk download stream launched.',
      'Retry Failed Jobs': 'Queued 2 failed export jobs for retry.',
      'Manage Templates': 'Navigating to templates configuration…',
      'Export Center': 'Opening automated export schedules…',
      'Downloaded': `Downloaded report: ${label}`,
      'Retried': `Retriggered generation job: ${label}`,
      'Deleted': `Archived report record: ${label}`,
      'Link copied': `Secure link copied: ${label}`,
    };
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          ...
          <div>
            ...
            <p className="text-[13.5px] text-text-muted/80 mt-2 leading-snug max-w-xl">
              System health indicators, delivery metrics, and recent generation activity.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-4">
          ...
          <Panel className="flex flex-col h-full">
            <PanelHead
              ...
              sub="Last 7 days — emails & failures"
              right={
                <div className="flex items-center gap-3">
                  {[
