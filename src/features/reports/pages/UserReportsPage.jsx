...
const PAGE = {
  eyebrow: 'Reports',
  title: 'User Reports',
  description: 'Custom compliance audits, KYC latency reviews, dormant status tracking, and risk analysis summaries.',
};
...
function UserReportsPage() {
  ...
  const act = (msg, id) => {
    ...
    else if (msg === 'Generate') message = `User Report Generation console initialized successfully.`;
    else if (msg === 'Exported') message = `Bulk exports generated for all user reports matching search.`;
    else message = `${msg}: ${id}`;
