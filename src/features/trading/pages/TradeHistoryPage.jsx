...
function TradeHistoryPage() {
  ...
  const columns = [
    ...
    { key: 'openTime', label: 'Opened', render: (val) => <span className="font-mono text-[11px] text-text-muted/60">{val}</span> },
    { key: 'closeTime', label: 'Closed', render: (val) => <span className="font-mono text-[11px] text-text-muted/60">{val}</span> },
    { key: 'size', label: 'Size', render: (val) => <span className="font-mono text-[12px] text-text-muted/75">{val}</span> },
    { key: 'openPrice', label: 'Open Px', render: (val) => <span className="font-mono text-[11px] text-text-muted/60">{val}</span> },
    { key: 'closePrice', label: 'Close Px', render: (val) => <span className="font-mono text-[11px] text-text-muted/60">{val}</span> },
    {
      key: 'pnl',
      label: 'P&L',
      render: (val) => {
